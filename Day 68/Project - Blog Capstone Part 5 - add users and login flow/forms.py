...
class ContactForm(FlaskForm):
    email = StringField("E-post", validators=[ DataRequired(message="E-post krävs"), Email(message="Ange en giltig e-postadress"), Length(max=250) ])
    message = TextAreaField("Meddelande", validators=[DataRequired(message="Meddelande krävs"),Length(min=10, max=2000, message="Meddelandet måste vara mellan 10 och 2000 tecken")])
